...
public class Const {
	...
	public static final String FWATERM = "aconfig/FWATERM.txt"; // 文字水印配置路径
	...
	public static final String IMAGEPATH = "/upload/"; // 图片上传路径
	public static final String FILEPATHTWODIMENSIONCODE = "uploadFiles/twoDimensionCode/"; // 二维码存放路径
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(app)|(weixin)|(static)|(main)|(websocket)|(login_toLogin)).*"; // 不对匹配该值的访问路径拦截（正则）
