...
<script type="text/javascript">
	...
	function save(){
	    ...
	    $.ajax({
            cache: true,
            type: "POST",
            url:'<%=basePath%>mt4Config/edit.do',
            data:$('#colorEditForm').serialize(),// 你的formid
            async: false,
	        ...
	        if (data.success == true) {
					...
					result=false;
					alert(data.msg);
				    location.href='<%=basePath%>mt4Config/editPage.do?id='+data.obj.id; 
				}
}
		  });
	    $("#zhongxin").hide();
...
<body>
	<form name="colorEditForm" id="colorEditForm" method="post">
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="serverIp" id="serverIp"
						maxlength="32" value="${mt4ConfigDto.serverIp}" placeholder="这里输入IP地址" title="IP地址" /></td>
				</tr>
				<tr>
					<td style="text-align: left"><span class="btn btn-small btn-info" style="width: 70px;margin-bottom: 10px;">端口号：</span></td>
					<td><input type="text" name="serverPort" id="serverPort" value="${mt4ConfigDto.serverPort}"
				...
				<tr>
					...
					<td><input type="text" name="lgManage" id="lgManage"
						maxlength="32" value="${mt4ConfigDto.lgManage}" placeholder="这里输入登录帐号" title="登录帐号" /></td>
				</tr>
				<tr>
					...
					<td><input type="text" name="lgPword" id="lgPword"
						maxlength="32"  value="${mt4ConfigDto.lgPword}" placeholder="这里输入登录密码" title="登录密码" /></td>
				</tr>
				<tr>
					...
					<td><input type="text" name="mid" id="mid" maxlength="32" disabled="disabled"
						placeholder="这里输入mid" value="${mt4ConfigDto.mid}"  title="mid" /></td>
				</tr>
				<tr>
					...
					<td><input type="text" name="userlever" id="userlever" disabled="disabled"
						maxlength="32" value="${mt4ConfigDto.userlever}" placeholder="这里输入用户等级" title="用户等级" /></td>
				</tr>
				<tr>
