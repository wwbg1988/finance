		...
		<div id="sidebar" class="menu-min">
				...
				<div id="sidebar-shortcuts">
					...
					<div id="sidebar-shortcuts-large">
						...
						<!-- btn btn-small btn-success btn btn-small btn-info btn btn-small btn-warning <button class="btn btn-small btn-success" onclick="changeMenu();" title="切换菜单"><i class="icon-pencil"></i></button> -->
				...
				<ul class="nav nav-list">
					...
					<li class="active" id="fhindex">
					  <a href="main/index.do"><i class="icon-dashboard"></i><span>后台首页</span></a>
					</li>
