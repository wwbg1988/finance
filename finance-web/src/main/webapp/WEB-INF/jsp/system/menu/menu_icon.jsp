	...
	<body>
		...
		<form action="menu/editicon.do" name="menuForm" id="menuForm" method="post">
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
					...
					<tr>
					<td><label onclick="seticon('product-icon');"><input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl">&nbsp;<i class="product-icon"  ></i></span></label></td>
					<td><label onclick="seticon('icon-iconfontgongjuxiang');"><input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl">&nbsp;<i class="icon-iconfontgongjuxiang"  ></i></span></label></td>
					<td><label onclick="seticon('icontupianguanli-icon');"><input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl">&nbsp;<i class="icontupianguanli-icon"  ></i></span></label></td>
					<td><label onclick="seticon('peicai-icon');"><input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl">&nbsp;<i class="peicai-icon"  ></i></span></label></td>
					<td><label onclick="seticon('qiecai-icon');"><input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl">&nbsp;<i class="qiecai-icon"  ></i></span></label></td>
					<td><label onclick="seticon('renyuanguanli-icon');"><input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl">&nbsp;<i class="renyuanguanli-icon"  ></i></span></label></td>
					<td><label onclick="seticon('shucai-icon');"><input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl">&nbsp;<i class="shucai-icon"  ></i></span></label></td>
					<td><label onclick="seticon('renyuanguanli-icon');"><input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl">&nbsp;<i class="renyuanguanli-icon"  ></i></span></label></td>
					<td><label onclick="seticon('shucai-icon');"><input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl">&nbsp;<i class="shucai-icon"  ></i></span></label></td>
				</tr>
